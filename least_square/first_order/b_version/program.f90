! this program is a test for the Least Square Method at the specific case of an straight line.
...
program program_least_quare
    ...
    write(*,*) 'of an straight line. Here it is made the calculation of the constants a and b '
